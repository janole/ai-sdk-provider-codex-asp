...
`ai-sdk-provider-codex-asp` is a Vercel AI SDK v6 custom provider for the Codex App Server Protocol.
...
```bash
npm install ai-sdk-provider-codex-asp ai
```
...
import { createCodexAppServer } from 'ai-sdk-provider-codex-asp';
