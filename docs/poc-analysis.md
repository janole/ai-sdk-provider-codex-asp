# PoC Analysis: ai-sdk-provider-codex-asp
...
`ai-sdk-provider-codex-asp` is a **Vercel AI SDK v3 provider** (`LanguageModelV3`) that speaks the
...
| Aspect | ai-sdk-provider-codex-asp | chat-server daemon |
|---|---|---|
